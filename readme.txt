...
By default, the plugin uses the user's friends's groups in order to suggest groups of the login user, but this can be extended through available filters.
...
Tested up to: BuddyPress 11.0.0

Special thanks goes to Brajesh Singh, whoes 'BP Groups Suggest Widget' (https://buddydev.com/plugins/bp-group-suggest/) gave the idea for extending it to a full plugin.
