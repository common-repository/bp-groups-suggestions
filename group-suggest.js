...
jQuery(document).ready(function() {
    ...
    j(".ls-bp-sug-gr-remove-from-widget").on('click','a', function() {
...
//gmponarou added at 6/11/2014
    j(".suggested-group-item-list div.remove-group-suggestion2").on('click','a', function() {
...
//remove button on groups directory page
 	j(".remove-from-groups-page").on('click', 'a', function() {
        var button = j(this);
...
//remove button on group home page
	...
	j(document).on('click','a.removesuggestion-group', function() {
        var url = j(this).attr('href');
...
//reset groups suggestions list  
    j(".reset-group-suggestions").on('click','a', function() {
        var url = j(this).attr('href');
        var button = j(this);
        button.addClass('loading');
        var nonce = get_var_in_url(url, "_wpnonce");
